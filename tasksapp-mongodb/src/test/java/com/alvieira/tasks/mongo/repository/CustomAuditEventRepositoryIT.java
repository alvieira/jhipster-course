package com.alvieira.tasks.mongo.repository;

import com.alvieira.tasks.mongo.TasksAppMongoApp;

import com.alvieira.tasks.mongo.config.Constants;
import com.alvieira.tasks.mongo.config.audit.AuditEventConverter;
import com.alvieira.tasks.mongo.domain.PersistentAuditEvent;
...
import static com.alvieira.tasks.mongo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
