...
import com.alvieira.tasks.mongo.domain.Task;
import com.alvieira.tasks.mongo.repository.TaskRepository;
...
/**
 * REST controller for managing {@link com.alvieira.tasks.mongo.domain.Task}.
 */
@RestController
@RequestMapping("/api")
