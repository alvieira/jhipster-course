...
import com.alvieira.tasks.config.audit.AuditEventConverter;
import com.alvieira.tasks.domain.PersistentAuditEvent;
...
import static com.alvieira.tasks.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
