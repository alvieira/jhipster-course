package com.alvieira.conference.web.rest;

import com.alvieira.conference.domain.Session;
import com.alvieira.conference.repository.SessionRepository;
import com.alvieira.conference.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.alvieira.conference.domain.Session}.
 */
@RestController
@RequestMapping("/api")
@Transactional
