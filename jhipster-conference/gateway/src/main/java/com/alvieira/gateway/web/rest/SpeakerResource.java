...
import com.alvieira.gateway.domain.Speaker;
import com.alvieira.gateway.repository.SpeakerRepository;
...
/**
 * REST controller for managing {@link com.alvieira.gateway.domain.Speaker}.
 */
@RestController
@RequestMapping("/api")
@Transactional
