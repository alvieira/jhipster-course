...
import com.alvieira.gateway.domain.Session;
import com.alvieira.gateway.repository.SessionRepository;
...
/**
 * REST controller for managing {@link com.alvieira.gateway.domain.Session}.
 */
@RestController
@RequestMapping("/api")
@Transactional
