package com.alvieira.gateway.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.alvieira.gateway.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.alvieira.gateway.repository.UserRepository.USERS_BY_EMAIL_CACHE);
